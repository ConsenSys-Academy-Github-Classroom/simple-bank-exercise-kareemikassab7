...
contract  SimpleBank {
    ...
    function withdraw(uint withdrawAmount) public returns (uint) {
      ...
      // 1. Use a require expression to guard/ensure sender has enough funds
        require(balances[msg.sender] >= withdrawAmount, "cannot withdraw amount larger than balance");
      ...
      //send that amount of ether to the user attempting to withdraw.
       ...
       msg.sender.transfer(withdrawAmount); // transfer after subtract as a security measure
